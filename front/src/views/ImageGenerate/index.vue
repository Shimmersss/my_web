...
.image-studio { min-height: calc(100vh - 72px); padding: 48px clamp(20px, 4vw, 72px) 80px; color: var(--desk-text); background: radial-gradient(circle at 78% 3%, rgba(204,111,77,.16), transparent 28%), var(--desk-bg); }
...
.studio-heading span { display:block; margin-top:12px; color:var(--desk-muted); }
.credit-pill { padding:10px 16px; border:1px solid var(--desk-border); border-radius:999px; background:rgba(255,255,255,.45); font-weight:700; white-space:nowrap; }
.studio-grid { max-width:1440px; margin:auto; display:grid; grid-template-columns:minmax(300px,420px) minmax(0,1fr); gap:20px; }
.control-panel,.result-panel { border:1px solid var(--desk-border); background:rgba(249,246,239,.88); box-shadow:0 18px 50px rgba(63,50,31,.08); }
...
.mode-tabs button.active { color:var(--desk-text); background:var(--desk-surface); box-shadow:0 3px 12px rgba(56,43,25,.08); }
...
.result-panel { min-height:620px; display:grid; place-items:center; overflow:hidden; background:linear-gradient(135deg,rgba(255,255,255,.35),rgba(229,218,201,.62)); }.result-ready { width:100%; height:100%; min-height:620px; display:flex; flex-direction:column; }.result-ready>img { width:100%; height:560px; object-fit:contain; padding:20px; box-sizing:border-box; }.result-actions { display:flex; justify-content:center; flex-wrap:wrap; gap:10px; padding:16px; border-top:1px solid var(--desk-border); }
.result-empty { text-align:center; color:var(--desk-muted); padding:30px; }.result-empty h2 { color:#353129; font-family:Georgia,serif; font-weight:500; }.canvas-mark { width:86px; height:86px; display:grid; place-items:center; margin:auto; border:1px solid #cfc2ae; border-radius:50%; font-size:32px; color:#b45740; }.orbit { width:78px; height:78px; margin:auto; border:1px solid #c9baa4; border-radius:50%; position:relative; animation:spin 2s linear infinite; }.orbit i { width:12px;height:12px;background:#b45740;border-radius:50%;position:absolute;top:-6px;left:33px; }@keyframes spin{to{transform:rotate(360deg)}}
.history-section { max-width:1440px; margin:54px auto 0; }.history-heading { margin-bottom:18px; }.history-heading h2 { margin:0; font-family:Georgia,serif; font-size:30px; font-weight:500; }.history-grid { display:grid; grid-template-columns:repeat(5,minmax(0,1fr)); gap:14px; }.history-card { min-width:0; position:relative; cursor:pointer; border:1px solid var(--desk-border); background:var(--desk-surface); transition:.2s; }.history-card:hover,.history-card.selected { transform:translateY(-3px); border-color:#ad5a43; box-shadow:0 12px 28px rgba(65,48,28,.1); }.thumb { aspect-ratio:1; display:grid; place-items:center; background:#ddd5c8; color:#766e62; }.thumb img { width:100%;height:100%;object-fit:cover; }.card-copy { padding:12px; }.card-copy small { color:#a04b37; }.card-copy p { margin:7px 0 0; font-size:13px; line-height:1.45; min-height:38px; }.delete-button { position:absolute; top:6px; right:6px; width:28px;height:28px;border:0;border-radius:50%;background:rgba(37,37,31,.75);color:#fff;font-size:20px;cursor:pointer; }.empty-history { color:#776f63; padding:30px 0; border-top:1px solid var(--desk-border); }
