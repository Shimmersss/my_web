...
def build_parser() -> argparse.ArgumentParser:
    ...
    apply.add_argument(
        ...
        action="store_true",
        help=(
            "Clear source body text, content pictures, tables, and charts before "
            "applying replacements. Master/theme/background/logo/decorative "
    ...
    try:
        ...
        if args.command == "apply":
            ...
            apply_plan(
                ...
                strip_source_content=args.strip_source_content,
            )
