...
.theme-gallery .reveal .slides section{padding-left:108px}.theme-gallery .layout-cover{text-align:center!important;align-items:center}.theme-gallery .layout-cover .accent{position:static;width:96px;height:2px}`,
    roman: `.theme-roman .reveal{background:radial-gradient(circle at 78% 18%,rgba(185,147,82,.18),transparent 24%),linear-gradient(115deg,rgba(255,255,255,.18),transparent 42%),var(--bg)}
.theme-roman .reveal .slides section{border-top:18px solid color-mix(in srgb,var(--surface) 78%,var(--bg));box-shadow:inset 0 3px 0 var(--accent),inset 0 -1px 0 color-mix(in srgb,var(--fg) 18%,transparent)}
.theme-roman .reveal .slides section::before{content:"";position:absolute;top:25px;right:48px;width:122px;height:10px;background:repeating-linear-gradient(90deg,var(--accent) 0 8px,transparent 8px 15px);opacity:.48}
.theme-roman .reveal h1,.theme-roman .reveal h2,.theme-roman .reveal blockquote{font-family:"Trajan Pro",Cinzel,Georgia,"Noto Serif SC",serif;font-weight:600;letter-spacing:-.018em}
.theme-roman .kicker{color:var(--accent);font-family:Georgia,"Noto Serif SC",serif;letter-spacing:.2em}.theme-roman .accent{width:132px;height:12px;border-top:3px solid var(--accent);border-bottom:3px solid var(--accent);background:transparent}
.theme-roman .layout-cover .cover-copy::after{content:"SPQR";display:block;margin-top:34px;color:var(--accent);font:700 20px/1 Georgia,serif;letter-spacing:.32em;opacity:.48}
.theme-roman .metric,.theme-roman .process-track li,.theme-roman .comparison-grid article,.theme-roman .evidence-callout{border-radius:0;box-shadow:inset 0 0 0 1px color-mix(in srgb,var(--fg) 16%,transparent)}
.theme-roman .step-index{font-family:Georgia,serif}.theme-roman .step-index::before{content:"· ";color:var(--accent)}`
  };
  return rules[style] || '';
}
...
.present[data-motion]:not([data-motion="none"])>.accent{transform-origin:left center;animation:deck-draw .48s cubic-bezier(.22,.8,.24,1) both}.present[data-motion="editorial"] .metric,.present[data-motion="editorial"] .comparison-grid article{animation:deck-rise .44s .04s ease-out both}.present[data-motion="editorial"] .metric:nth-child(2),.present[data-motion="editorial"] .comparison-grid article:nth-child(2),.present[data-motion="flow"] li:nth-child(2){animation-delay:.10s!important}.present[data-motion="editorial"] .metric:nth-child(3),.present[data-motion="flow"] li:nth-child(3){animation-delay:.18s!important}.present[data-motion="editorial"] .metric:nth-child(4),.present[data-motion="flow"] li:nth-child(4){animation-delay:.26s!important}
.theme-roman .present:not([data-motion="none"]) h1,.theme-roman .present:not([data-motion="none"]) h2{animation:deck-inscription .62s cubic-bezier(.16,.84,.24,1) both}.theme-roman .present:not([data-motion="none"]) .headline{animation:deck-rise .5s .12s ease-out both}
@keyframes deck-calm{from{opacity:.55;transform:translateY(8px)}to{opacity:1;transform:none}}@keyframes deck-rise{from{opacity:0;transform:translateY(18px)}to{opacity:1;transform:none}}@keyframes deck-fade{from{opacity:0}to{opacity:1}}@keyframes deck-focus{from{opacity:.2;transform:scale(.985)}to{opacity:1;transform:none}}@keyframes deck-flow{from{opacity:0;transform:translateX(22px)}to{opacity:1;transform:none}}@keyframes deck-image{from{opacity:.72;transform:scale(1.025)}to{opacity:1;transform:scale(1)}}@keyframes deck-draw{from{opacity:0;transform:scaleX(.08)}to{opacity:1;transform:scaleX(1)}}@keyframes deck-inscription{from{opacity:0;letter-spacing:.055em;transform:translateY(12px)}to{opacity:1;letter-spacing:-.018em;transform:none}}
